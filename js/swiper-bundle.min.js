...
!(function (e, t) {
    ...
    function T(e, t) {
        ...
        return (
            r.WebKitCSSMatrix
                ...
                : (a = (s = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,'))
                      .toString()
                      .split(',')),
                    ...
                    if (!(a.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(h, 2)) < a.params.threshold)) {
                        ...
                        if (void 0 === i.isScrolling)
                            (a.isHorizontal() && n.currentY === n.startY) || (a.isVertical() && n.currentX === n.startX)
                                ? (i.isScrolling = !1)
                                : c * c + h * h >= 25 && ((v = (180 * Math.atan2(Math.abs(h), Math.abs(c))) / Math.PI), (i.isScrolling = a.isHorizontal() ? v > s.touchAngle : 90 - v > s.touchAngle));
                        if (
                            (i.isScrolling && a.emit('touchMoveOpposite', o), void 0 === i.startMoving && ((n.currentX === n.startX && n.currentY === n.startY) || (i.startMoving = !0)), i.isScrolling)
                        )
                            i.isTouched = !1;
                            ...
                            if (
                                ...
                                f > 0 && i.currentTranslate > a.minTranslate()
                                    ? ((g = !1), s.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + f, y)))
                                    : f < 0 &&
                                      i.currentTranslate < a.maxTranslate() &&
                                      ((g = !1), s.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - f, y))),
        ...
        if (((a.isTouched = !1), (a.isMoved = !1), (a.startMoving = !1), (p = i.followFinger ? (r ? t.translate : -t.translate) : -a.currentTranslate), !i.cssMode))
            if (i.freeMode) {
                ...
                if (i.freeModeMomentum) {
                    ...
                    if (w < t.maxTranslate())
                        i.freeModeMomentumBounce ? (w + t.maxTranslate() < -S && (w = t.maxTranslate() - S), (b = t.maxTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (w = t.maxTranslate()),
                            i.loop && i.centeredSlides && (T = !0);
                    else if (w > t.minTranslate())
                        i.freeModeMomentumBounce ? (w - t.minTranslate() > S && (w = t.minTranslate() + S), (b = t.minTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (w = t.minTranslate()),
                            i.loop && i.centeredSlides && (T = !0);
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== s) {
                        ...
                        'string' == typeof b && b.indexOf('%') >= 0 && (b = (parseFloat(b.replace('%', '')) / 100) * s),
                            ...
                            a.slidesPerColumn > 1 &&
                                ((C = Math.floor(u / a.slidesPerColumn) === u / e.params.slidesPerColumn ? u : Math.ceil(u / a.slidesPerColumn) * a.slidesPerColumn),
                            ...
                            if (a.slidesPerColumn > 1) {
                                ...
                                if ('row' === a.slidesPerColumnFill && a.slidesPerGroup > 1) {
                                    ...
                                    (O = (A = N - (D = Math.floor(N / B)) * B + G * a.slidesPerGroup) + (D * C) / P),
                                        I.css({ '-webkit-box-ordinal-group': O, '-moz-box-ordinal-group': O, '-ms-flex-order': O, '-webkit-order': O, order: O });
                                } else
                                    'column' === a.slidesPerColumnFill
                                        ? ((D = $ - (A = Math.floor($ / P)) * P), (A > L || (A === L && D === P - 1)) && (D += 1) >= P && ((D = 0), (A += 1)))
                                        : (A = $ - (D = Math.floor($ / k)) * k);
                        ...
                        if (
                            ...
                            r && n && ('slide' === a.effect || 'coverflow' === a.effect) && i.css({ width: e.virtualSize + a.spaceBetween + 'px' }),
                            a.setWrapperSize && (e.isHorizontal() ? i.css({ width: e.virtualSize + a.spaceBetween + 'px' }) : i.css({ height: e.virtualSize + a.spaceBetween + 'px' })),
                            a.slidesPerColumn > 1 &&
                                ((e.virtualSize = (M + a.spaceBetween) * C),
                                (e.virtualSize = Math.ceil(e.virtualSize / a.slidesPerColumn) - a.spaceBetween),
                                e.isHorizontal() ? i.css({ width: e.virtualSize + a.spaceBetween + 'px' }) : i.css({ height: e.virtualSize + a.spaceBetween + 'px' }),
                                a.centeredSlides))
                        ) {
                            z = [];
                        ...
                        if (
                            (0 === c.length && (c = [0]),
                            0 !== a.spaceBetween &&
                                (e.isHorizontal() ? (r ? p.filter(f).css({ marginLeft: b + 'px' }) : p.filter(f).css({ marginRight: b + 'px' })) : p.filter(f).css({ marginBottom: b + 'px' })),
                    ...
                    i.loop && 0 === d.length && (d = a.eq(-1)).addClass(i.slidePrevClass),
                        i.loop &&
                            (o.hasClass(i.slideDuplicateClass)
                                ? s
                                      .children('.' + i.slideClass + ':not(.' + i.slideDuplicateClass + ')[data-swiper-slide-index="' + o.attr('data-swiper-slide-index') + '"]')
                                      .addClass(i.slideDuplicateNextClass)
                                : s
                                      .children('.' + i.slideClass + '.' + i.slideDuplicateClass + '[data-swiper-slide-index="' + o.attr('data-swiper-slide-index') + '"]')
                                      .addClass(i.slideDuplicateNextClass),
                    ...
                    if (l && (!l || 0 !== Object.keys(l).length)) {
                        ...
                        if (o && e.currentBreakpoint !== o) {
                            ...
                            h && a && e.changeDirection(),
                                S(e.params, p),
                                S(e, { allowTouchMove: e.params.allowTouchMove, allowSlideNext: e.params.allowSlideNext, allowSlidePrev: e.params.allowSlidePrev }),
    ...
    var W = {
            update: function (e) {
                ...
                else for (var z = p; z <= u; z += 1) (z < b || z > E) && t.$wrapperEl.find('.' + t.params.slideClass + '[data-swiper-slide-index="' + z + '"]').remove();
            ...
            handle: function (e) {
                ...
                if (
                    ...
                    t.isHorizontal()
                        ...
                        : ((p || u || v || f) && (n.preventDefault ? n.preventDefault() : (n.returnValue = !1)), (u || f) && t.slideNext(), (p || v) && t.slidePrev()),
                        t.emit('keyPress', o);
                }
            },
            enable: function () {
    ...
    var U = {
        ...
        Z = {
            update: function () {
                ...
                if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if (
                        ('fraction' === a.type && (r.find('.' + a.currentClass).text(a.formatFractionCurrent(i + 1)), r.find('.' + a.totalClass).text(a.formatFractionTotal(n))),
                        'progressbar' === a.type)
                    ) {
                        var E;
            ...
            init: function () {
                ...
                if (t.el) {
                    ...
                    0 !== a.length &&
                        ...
                        'bullets' === t.type &&
                            t.dynamicBullets &&
                            (a.addClass('' + t.modifierClass + t.type + '-dynamic'), (e.pagination.dynamicBulletIndex = 0), t.dynamicMainBullets < 1 && (t.dynamicMainBullets = 1)),
        ...
        J = {
            ...
            enableDraggable: function () {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    l.touch
                        ? (o.addEventListener(i.start, e.scrollbar.onDragStart, d), o.addEventListener(i.move, e.scrollbar.onDragMove, d), o.addEventListener(i.end, e.scrollbar.onDragEnd, p))
                        : (o.addEventListener(s.start, e.scrollbar.onDragStart, d), t.addEventListener(s.move, e.scrollbar.onDragMove, d), t.addEventListener(s.end, e.scrollbar.onDragEnd, p));
                }
            },
            disableDraggable: function () {
                ...
                if (e.params.scrollbar.el) {
                    var t = r(),
                        ...
                        p = !(!l.passiveListener || !n.passiveListeners) && { passive: !0, capture: !1 };
                    l.touch
                        ? (o.removeEventListener(i.start, e.scrollbar.onDragStart, d), o.removeEventListener(i.move, e.scrollbar.onDragMove, d), o.removeEventListener(i.end, e.scrollbar.onDragEnd, p))
            ...
            destroy: function () {
                ...
                a.a11y.liveRegion && a.a11y.liveRegion.length > 0 && a.a11y.liveRegion.remove(),
                    ...
                    a.pagination &&
                        ...
                        a.pagination.$el.off('keydown', '.' + a.params.pagination.bulletClass.replace(/ /g, '.'), a.a11y.onEnterKey);
            },
        },
        se = {
            init: function () {
                ...
                if (e.params.history) {
                    ...
                    (a.initialized = !0),
                        ...
                        (a.paths.key || a.paths.value) &&
                            (a.scrollToSlide(0, a.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener('popstate', e.history.setHistoryPopState));
                }
            },
            destroy: function () {
                var e = l();
            ...
            init: function () {
                ...
                return (
                    t.swiper instanceof a
                        ...
                        : C(t.swiper) && ((e.thumbs.swiper = new a(S({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
                    ...
                    if (t.realIndex !== a.realIndex || r) {
                        ...
                        r && (n += 'next' === l ? s : -1 * s),
                            a.visibleSlidesIndexes &&
                                ...
                                (a.params.centeredSlides ? (n = n > o ? n - Math.floor(i / 2) + 1 : n + Math.floor(i / 2) - 1) : n > o && (n = n - i + 1), a.slideTo(n, e ? 0 : void 0));
                    }
                    var u = 1,
        ...
        ce = [
            ...
            },
            {
                name: 'thumbs',
                params: {
                    thumbs: { swiper: null, multipleActiveThumbs: !0, autoScrollOffset: 0, slideThumbActiveClass: 'swiper-slide-thumb-active', thumbsContainerClass: 'swiper-container-thumbs' },
                },
                create: function () {
